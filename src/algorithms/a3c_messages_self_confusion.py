...
from algorithms.common_funcs_messages_self_confusion import msg_postprocess_trajectory, setup_next_reward_prediction_loss, \
...
def build_a3c_self_confusion_messages_trainer(msg_config):
    tf.keras.backend.set_floatx("float32")
    trainer_name = "SelfConfusionMessagesA3CTrainer"
